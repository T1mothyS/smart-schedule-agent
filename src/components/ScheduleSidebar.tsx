...
import { Plus, Check, Trash2, Edit3, X, SettingsIcon } from 'lucide-react';
...
export function ScheduleSidebar({ activeCalendarIds, onActiveChange, onCalendarsLoaded }: ScheduleSidebarProps) {
